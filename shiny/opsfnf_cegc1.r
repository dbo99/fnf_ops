...
c_trin_fnf <- read.table(text = substring(c_rawtext, regexpr(start, c_rawtext), regexpr(end, c_rawtext)))
c_trin_fnf
rm(c_rawtext)
}
...
p_trin_fnf <- read.table(text = substring(p_rawtext, regexpr(start, p_rawtext), regexpr(end, p_rawtext)))
p_trin_fnf
rm(p_rawtext)
